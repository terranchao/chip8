...
int main(int argc, char *argv[])
{
    ...
    if (argc != 4)
    {
        printf(
            ...
            "It should be noted that this interpreter attempts to refresh the "
            "display at a rate of 60Hz by default, and that setting `scale` too"
            " high can lead to dropped frames - this will vary with the "
            "capabilities of different host machines.                       \n"
